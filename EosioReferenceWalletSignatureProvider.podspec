#
# Be sure to run `pod lib lint EosioReferenceWalletSignatureProvider.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/EOSIO/eosio-swift-reference-wallet-signature-provider.git', :tag => "v" + s.version.to_s }

  s.swift_version         = '4.2'
  s.ios.deployment_target = '11.0'

  s.source_files = 'EosioReferenceWalletSignatureProvider/**/*.swift'
